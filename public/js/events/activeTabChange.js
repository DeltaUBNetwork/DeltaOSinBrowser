...
function activeTabChange (data) {
  ...
  if (iframe.src != 'https://genow.cf/newtab.html' && sr.indexOf('/service/') > -1 &&iframe.contentWindow.location.href.indexOf('https://edumarklearning.org/service/') ==-1){
...
//  var surelol = input.split("genow://")[1]
    ...
    adr.innerText = "genow://" + iframe.contentWindow.location.href.split("/hostedPages/")[1]
